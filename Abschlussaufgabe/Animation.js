    ...
    function init(_event) {
        ...
        document.querySelector("body").addEventListener("keydown", function (e) {
            ...
            switch (e.keyCode) {
                //linke Pfeiltaste
                case 37:
                    L12_Canvas.clMixer.move_Mixer(document.querySelector('canvas').clientWidth - document.querySelector('canvas').clientWidth);
                    break;
                //rechte Pfeiltaste
                case 39:
                    L12_Canvas.clMixer.move_Mixer(document.querySelector('canvas').clientWidth - 100);
                    break;
            }
        });
